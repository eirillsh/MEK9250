    ...
    for length_factor in [0.25, 0.125, 0.0625, 0.03125, 0.015625]:
        ...
        for timestep in [1/100, 1/200, 1/400, 1/800, 1/1600]:
            if velocity_element_degree == 1:
                filename_prefix = "explicit_output/" + scheme_type + "_linear_V_elements_dt=" + str(timestep) + "_mesh_LF=" + str(length_factor) + "_"
            elif velocity_element_degree == 2:
                filename_prefix = "explicit_output/" + scheme_type + "_quadratic_V_elements_dt=" + str(timestep) + "_mesh_LF=" + str(length_factor) + "_"
            else:
